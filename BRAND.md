...
- **Short sentences carry the page.** Five to fourteen words. Break long ones.
- **Lead with the noun.** "Friday morning. Lake Mary route." not "Deliveries to Lake Mary happen on Friday mornings."
- **Periods over commas, commas over colons, colons over parens, parens over dashes.** No em-dashes, ever.
- **Numerals when informational.** $3.50/oz, 10%, ten varieties, 8 days from seed.
