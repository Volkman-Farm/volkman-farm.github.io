---
title: School lunches with a secret
description: "How to get microgreens into a wrap or a lunchbox so they survive a backpack until noon. Which varieties hold, where they go in the roll, and what to skip."
date: 2026-08-10T09:00:00-04:00
pillar: In the kitchen
hero: /assets/blog/school-lunches-with-a-secret.svg
hero_alt: "Line drawing of an open lunchbox holding a wrap cut on the diagonal with microgreens showing in the spiral, a small apple, and an ice pack tucked along one side"
image: /assets/blog/school-lunches-with-a-secret.png
---
...
## The wrap does most of the work

A rolled tortilla is a better container for microgreens than two slices of bread, and it is not close.

Lay the tortilla out and think in layers. The spread goes on the tortilla. The meat or the cheese or the beans go on the spread. The greens go on top of that, against something dry, as far from anything wet as the geometry allows. Then roll it tight.

Tight matters. A loose roll lets the greens shift and bruise all morning. A tight one presses everything into a solid cylinder where the leaves are held in place and shielded on every side by the fillings, which is a much kinder ride than sitting loose in a sandwich. Cut it in half on the diagonal and set the halves cut side up, because the spiral of green showing in the cross section is the entire sales pitch. Nobody has to be talked into a wrap that already looks good.

If it has to be a sandwich, use fat as a wall. Butter, cream cheese, mayo, or hummus spread all the way to the crust keeps the bread from wicking, and the greens go directly against that layer with the tomato as far away as you can get it. Wet slices go in a separate bag or they do not go.

One rule carries over from the [jar salad post](/blog/summer-salads-that-dont-wilt-by-noon/), because the science is the same and we will not run it twice: dressing and greens do not travel together. Anything with salt and acid in it starts taking a leaf apart on contact.

## Which ones survive a backpack
...
And do not chop any of it. They are already the size they are meant to be, and cutting them opens up cell walls that were working for you.
