---
title: "Mulch: the cheapest tool we have"
description: "Where to get free wood chips in Central Florida, how deep to lay them, how often to top up in this heat, and the three mistakes that turn a good pile into a problem."
date: 2026-08-26T09:00:00-04:00
pillar: Permaculture in practice
hero: /assets/blog/mulch-the-cheapest-tool-we-have.svg
hero_alt: "Line drawing of a wheelbarrow full of wood chips beside a young tree with a ring of mulch around it, showing a gap of bare ground left around the trunk"
image: /assets/blog/mulch-the-cheapest-tool-we-have.png
---
...
Third, take-what-comes is really a first-load rule. Crews work the same few square miles for years, and a driveway that is easy to dump in, belonging to somebody who did not complain about what showed up last time, is worth remembering. Once you are on that list you can start asking. Not demanding, asking. Leafy summer chips for a bed you want breaking down fast, coarser and woodier for a path you want to stay put, nothing with palm in it if you have found palm too stringy to move. And if you do not know what to ask for, say that and describe what you are trying to do instead. An arborist is looking at this material every working day and can usually tell you what a given load is going to act like once it is on the ground, which is the part that is hardest to guess in advance.
...
About once a year here.

This is the part people from cooler places get wrong about Florida. Mulch does not sit. Heat plus humidity plus rain plus a full year of fungal activity means a four inch layer is noticeably thinner twelve months later, and that is not a failure. It went somewhere. It went into the ground as the exact thing you were trying to build.

So top up annually and treat the disappearing act as the receipt.
...
**Waiting for a plan.** A pile that sits in the driveway for two months while you decide on a design is a pile that has already lost you a season of shade on the ground. Move it out onto whatever is bare. It is not a permanent decision. You can plant straight through it later.

The unglamorous truth is that mulch is the highest return thing we do on this property and it costs a phone call and a weekend of moving it around. Compare that to the shed out back, where every tray represents [seed, soil, water, and two weeks of electricity](/greens/). Both are worth doing. Only one of them is free.
