...
hero_alt: "Line drawing of a phone showing a short message thread beside a stack of two clamshell containers of greens"
image: /assets/blog/subscribe-and-save-how-the-10-percent-works.png
---

$3.50 an ounce becomes $3.15 if you stand a weekly order. On 4oz a week that's $1.40, about $72 a year.

Nothing is automatic. Nothing gets charged to a card. Stopping takes one word.

Most people asking about a subscription aren't really asking about the price. They're asking how hard it'll be to get out of, because they've been burned by a portal with the cancel button buried 4 screens deep. So we'll lay out the whole mechanism first, then the part nobody explains, which is why the discount exists at all.
