---
title: The car is the warehouse
description: "There is no cold room and no delivery van. Everything that goes out on a route rides in the family car, and that turns out to set the ceiling on the whole operation."
date: 2026-09-10T09:00:00-04:00
pillar: On the route
hero: /assets/blog/the-car-is-the-warehouse.svg
hero_alt: "Line drawing of the back of a family SUV with the hatch open and two insulated cooler bags loaded inside, a stack of clamshell containers beside them"
image: /assets/blog/the-car-is-the-warehouse.png
---

There's no warehouse. No cold room, no box truck with a logo on the side, no second vehicle that exists only for this.

There's the family car.

Everything that leaves here on a delivery morning gets loaded into the same car that does school pickup, and that one fact explains more about how this farm works than anything on the pricing page. People picture a small farm and imagine a scaled-down version of a big one. A little truck instead of a big truck. What we have is a Telluride with the third row down.
...
Next time something shows up at your door from a small operation, ask yourself what it rode in. The answer usually tells you more about how it was handled than any label on the package.
