---
title: Beet greens, the pretty ones
description: "Beet microgreens are the slowest crop we grow and the one chefs ask for by name. Neon pink stems, mild earthy flavor, and why they take twice as long as radish."
date: 2026-07-19T09:00:00-04:00
pillar: Variety spotlight
hero: /assets/blog/beet-greens-the-pretty-ones.svg
hero_alt: "Line drawing of slender beet microgreen stems with small paired leaves rising from a shallow tray, a few seed clusters on the soil, and a small sun above"
image: /assets/blog/beet-greens-the-pretty-ones.png
---
...
Beet seed does not want to wake up. What you sow is not really a seed but a dried cluster, a hard little husk with more than one seed inside, and it takes its time about softening. So we soak beet overnight before it ever touches soil, in a glass measuring cup on the counter, which is exactly as high-tech as this operation gets. That is not optional the way it is for some varieties. Sow beet dry and you get a patchy, half-empty tray.
...
We should say the harder thing too, because a variety spotlight that only lists the good parts is an advertisement. Beet molds. It is the crop we lose most often, and it is not close.
...
The flavor is milder than the color suggests. Earthy and a little sweet, like a full-grown beet green but softer, without the mineral bite. The stem is crisp, the leaf is tender. People brace for something intense because it looks intense, and then it turns out to be one of the gentler greens we sell.

Nutritionally it carries the betalains, the pigments that make beets pink in the first place, which are studied as antioxidants. It is also a strong source of folate, iron, and vitamin C. As always, we will let that sit there without dressing it up.
