---
title: Cover crop check-in
description: "Three weeks after we broadcast a fifty pound bag over the front three quarters of an acre, the field is green and we still cannot tell you what most of it is."
date: 2026-08-25T09:00:00-04:00
pillar: Homestead journal
hero: /assets/blog/cover-crop-check-in.svg
hero_alt: "Line drawing of a field of young cover crop seedlings of mixed heights seen at ground level, with old mowed stalks lying underneath them"
image: /assets/blog/cover-crop-check-in.png
---
...
Not green in patches, either, which is the part we did not take for granted. Broadcasting onto mowed residue is a rough way to plant. You are not putting seed at a set depth in a clean bed, you are throwing it across a mat of old stalks and trusting rain and gravity to work it down to where it needs to be. Some of it lands well. Some of it lands on a stalk and sits there being a snack for something. We knew going in that the stand might come up blotchy, and we were prepared to write that post instead.

It came up even. Whatever fell where, it fell close enough to everywhere.

## What we cannot tell you yet

Which of it is what.

There are eight things in that bag. Four legumes and four fast nurse crops, everything from sunn hemp to millet to sunflowers to dwarf corn, and at three weeks a lot of them are still at the stage where a young plant is just a green thing with two leaves and an opinion about the sun. We can walk it and see a stand. We cannot walk it and give you an inventory, and we are not going to pretend otherwise by naming the species we would expect to see.

Ask us in a few weeks. The sunflowers and the corn will announce themselves by getting taller than everything else, and the rest sorts itself out as the leaf shapes fill in. That will be a better post than this one because it will have actual detail in it. This one has one finding.
