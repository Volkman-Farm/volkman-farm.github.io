---
title: Shade is an asset, not a problem
description: "Seed packets are written for places that are not Florida. In August, shade here is not a shortage of light. It is the part of the day worth planting into."
date: 2026-08-19T09:00:00-04:00
pillar: Permaculture in practice
hero: /assets/blog/shade-is-an-asset-not-a-problem.svg
hero_alt: "Line drawing of a lot seen from the side with tall trees at both edges, a small gabled building toward the right, a sun overhead, and hatched bands of shadow on the ground at each end leaving an open sunlit strip in the middle"
image: /assets/blog/shade-is-an-asset-not-a-problem.png
---
...
The trees at the south end are the ones we would least want to lose. That corner is where the flock lives, and a Florida afternoon in August is not a mild thing to sit through with feathers on. We did not put the run there for the shade, and we are not going to pretend we planned it that way. The run went where it went, the trees were already there, and the result is that the birds have somewhere to be at two in the afternoon that is not the inside of an oven. Sometimes a good outcome is just a thing you did not ruin.

Edge shade is different. It comes at the ends of the day, sweeping in from the fence lines in the morning and again in the evening, and it is short. What it does is take the ground temperature down at the two moments when the soil is either about to be cooked or has just finished being cooked. That matters more than it sounds like it should. Ground that never gets a break holds less water and grows less life in it, and the mulch we keep talking about is doing the same job from the other direction.

Building shade is the one we have the most control over and have done the least with. It is dense, it is predictable, and it sits in exactly the same place every year, which makes it the easiest to design around and the easiest to forget about.
