...
hero_alt: "Line drawing of a backyard seen from above with a shed, a fence, planted mounds, and dashed lines tracing where sun, shade, and water move across the lot"
image: /assets/blog/mapping-the-yard-before-touching-it.png
---

The mounds out back look like we knew what we were doing. We did not, not at first. What we had was a lot of standing around in our own yard, doing nothing, which is harder than it sounds and is most of what this post is about.

Everybody who buys a house with a yard has the same first instinct. Go get a shovel. Pick the spot that looks nice from the kitchen window and put the garden there. We had that instinct too. The only reason we did not act on it is that we had been reading enough to be nervous, and the one idea that stuck was this: the yard already knows things you do not, and it will tell you for free if you shut up and watch.
...
The other half is light. Shade moves. This is obvious when you say it and completely invisible if you only ever look at your yard at one time of day. The picture you have in your head is probably five in the afternoon, because that is when you are home. That picture is a lie about the other eleven hours. So we started looking in the morning, at noon, in the evening, in different months, and the yard turned out to have a sun and shade pattern that had very little to do with what we assumed from the back door.

Then there is the part you cannot see at all. The water table sits high here. We wrote about that when we wrote about [the shed](/blog/the-shed-albert-built/), because it is the reason the pad got built up off the grade instead of poured flush. You do not learn that by looking. You learn it from neighbors, from what happens when you dig, from the way this whole part of the state behaves. Some of the map is under the ground and you assemble it secondhand.

## What the watching bought us
...
The greens keep going the whole time, of course. The shed does not care what the yard is doing. If you want the working end of all this, [start an order](/order/) and we will hand you something that was alive a few hours before it reached your porch.
